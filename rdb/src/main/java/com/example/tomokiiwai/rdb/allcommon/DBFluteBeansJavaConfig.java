package com.example.tomokiiwai.rdb.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="com.example.tomokiiwai.rdb.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.example.tomokiiwai.rdb.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.example.tomokiiwai.rdb.allcommon.ImplementedInvokerAssistant();
    }
