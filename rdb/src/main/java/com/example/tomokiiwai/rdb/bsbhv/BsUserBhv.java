package com.example.tomokiiwai.rdb.bsbhv;
...
import com.example.tomokiiwai.rdb.bsbhv.loader.*;
import com.example.tomokiiwai.rdb.exentity.*;
import com.example.tomokiiwai.rdb.bsentity.dbmeta.*;
import com.example.tomokiiwai.rdb.cbean.*;
...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<User> selectByPK(Long id) {
        return facadeSelectByPK(id);
    }

    protected OptionalEntity<User> facadeSelectByPK(Long id) {
        return doSelectOptionalByPK(id, typeOfSelectedEntity());
    }

    protected <ENTITY extends User> ENTITY doSelectByPK(Long id, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(id), tp);
    }

    protected <ENTITY extends User> OptionalEntity<ENTITY> doSelectOptionalByPK(Long id, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(id, tp), id);
    }

    protected UserCB xprepareCBAsPK(Long id) {
     ...
     */
    public List<Long> extractIdList(List<User> userList)
